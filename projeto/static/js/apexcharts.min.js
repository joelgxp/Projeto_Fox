    ...
    , X = function() {
      ...
      return r(t, [{
          ...
          value: function(t) {
              ...
              return k = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(T) : this.calculateColumnsDataLabelsPosition(T),
              u.attr({
                  cy: k.bcy,
                  cx: k.bcx,
                  j: o,
    ...
    , Y = function() {
      ...
      return r(t, [{
          ...
          value: function(t) {
              ...
              b = b + g.line(p, f.y2) + f.pathWithRadius + g.line(x - o, f.y2) + y + y + "z",
              v = v + g.line(p, s) + y + y + y + y + y + g.line(p, s),
              d.config.chart.stacked && (this.barCtx.yArrj.push(f.y2WithRadius),
              this.barCtx.yArrjF.push(Math.abs(s - f.y2WithRadius)),
          ...
          value: function(t) {
              ...
              var x = e
                , b = e + i
                , v = d.line(a, b - r);
              return f = f + d.line(u.x2, x) + u.pathWithRadius + d.line(u.x2, b - r) + v + v + "z",
              p = p + d.line(a, x) + v + v + v + v + v + d.line(a, x),
              c.config.chart.stacked && (this.barCtx.xArrj.push(u.x2WithRadius),
              this.barCtx.xArrjF.push(Math.abs(a - u.x2WithRadius)),
    ...
    , F = function() {
      ...
      return r(t, [{
          ...
          value: function(t) {
              ...
              M.count > 0 && s >= S.globals.dataPoints - M.count && (P.node.setAttribute("stroke-dasharray", M.dashArray),
              P.node.setAttribute("stroke-width", M.strokeWidth),
              P.node.setAttribute("fill-opacity", M.fillOpacity)),
    ...
    , j = function() {
      ...
      return r(t, [{
          ...
          value: function(t) {
                  ...
                  if (n.globals.axisCharts) {
                      if ("category" === n.config.xaxis.type || n.config.xaxis.convertedCatToNumeric)
                          if (n.globals.isBarHorizontal) {
                              ...
                              i = g.getLabel(n.globals.labels, n.globals.timescaleLabels, 0, t).text;
              ...
              n.globals.axisCharts || (l.push(n.config.chart.toolbar.export.csv.headerValue),
              h.push(l.join(s))),
              i.map((function(t, e) {
                  n.globals.axisCharts ? function(t, e) {
                      ...
                      t.data && t.data.length)
                          for (var a = 0; a < t.data.length; a++) {
                              ...
                              0 === e) {
                                  l.push((c = r,
                                  "datetime" === n.config.xaxis.type && String(c).length >= 10 ? n.config.chart.toolbar.export.csv.dateFormatter(r) : x.isNumber(r) ? r : r.split(s).join("")));
                                  for (var o = 0; o < n.globals.series.length; o++)
                                      d.isFormatXY() ? l.push(i[o].data[a].y) : l.push(n.globals.series[o][a])
                              }
                              ("candlestick" === n.config.chart.type || t.type && "candlestick" === t.type) && (l.pop(),
                              l.push(n.globals.seriesCandleO[e][a]),
                              l.push(n.globals.seriesCandleH[e][a]),
                              l.push(n.globals.seriesCandleL[e][a]),
                              l.push(n.globals.seriesCandleC[e][a])),
                              ("boxPlot" === n.config.chart.type || t.type && "boxPlot" === t.type) && (l.pop(),
                              l.push(n.globals.seriesCandleO[e][a]),
                              l.push(n.globals.seriesCandleH[e][a]),
                              l.push(n.globals.seriesCandleM[e][a]),
                              l.push(n.globals.seriesCandleL[e][a]),
                              l.push(n.globals.seriesCandleC[e][a])),
                              "rangeBar" === n.config.chart.type && (l.pop(),
                              l.push(n.globals.seriesRangeStart[e][a]),
                              l.push(n.globals.seriesRangeEnd[e][a])),
                              l.length && h.push(l.join(s))
                          }
                      var c
                  }(t, e) : ((l = []).push(n.globals.labels[e].split(s).join("")),
                  l.push(n.globals.series[e]),
                  h.push(l.join(s)))
              }
              )),
              c += h.join(o),
    ...
    , Tt = function() {
      ...
      return r(t, [{
              ...
              if (o.config.stroke.show && !this.pointsChart) {
                  ...
                  for (var y = 0; y < r.linePaths.length; y++) {
                      var w = e(e({}, u), {}, {
                        ...
                        , k = n.renderPaths(w);
                      if (this.elSeries.add(k),
                      h.count > 0) {
                          var A = n.renderPaths(w);
                          A.node.setAttribute("stroke-dasharray", h.dashArray),
                          h.strokeWidth && A.node.setAttribute("stroke-width", h.strokeWidth),
                          this.elSeries.add(A),
                          A.attr("clip-path", "url(#forecastMask".concat(o.globals.cuid, ")")),
                          k.attr("clip-path", "url(#nonForecastMask".concat(o.globals.cuid, ")"))
                      }
                  }
              }
          }
          ...
          value: function(t) {
              for (var e = t.series, i = t.realIndex, a = t.i, s = t.x, r = t.y, o = t.pX, n = t.pY, l = t.pathsFrom, h = t.linePaths, c = t.areaPaths, d = t.seriesIndex, g = t.lineYPosition, u = t.xArrj, f = t.yArrj, p = this.w, b = new m(this.ctx), v = this.yRatio, y = l.prevY, w = l.linePath, k = l.areaPath, A = l.pathFromLine, S = l.pathFromArea, C = x.isNumber(p.globals.minYArr[i]) ? p.globals.minYArr[i] : p.globals.minY, L = p.globals.dataPoints > 1 ? p.globals.dataPoints - 1 : p.globals.dataPoints, P = 0; P < L; P++) {
                  ...
                  if (p.globals.isXNumeric) {
                      ...
                      void 0 === p.globals.seriesX[i][P + 1] && (T = p.globals.seriesX[i][L - 1]),
                      s = (T - p.globals.minX) / this.xRatio
                  } else
                      s += this.xDivision;
                  if (p.config.chart.stacked)
                      ...
                      g = this.zeroY;
                  r = M ? g - C / v[this.yaxisIndex] + 2 * (this.isReversed ? C / v[this.yaxisIndex] : 0) : g - e[a][P + 1] / v[this.yaxisIndex] + 2 * (this.isReversed ? e[a][P + 1] / v[this.yaxisIndex] : 0),
                  u.push(s),
                  f.push(r);
          ...
          value: function(t) {
              ...
              "smooth" === x) {
                  var v = .35 * (r - n);
                  f.globals.hasNullValues ? (null !== e[i][s] && (null !== e[i][s + 1] ? (h = p.move(n, l) + p.curve(n + v, l, r - v, o, r + 1, o),
                  c = p.move(n + 1, l) + p.curve(n + v, l, r - v, o, r + 1, o) + p.line(r, b) + p.line(n, b) + "z") : (h = p.move(n, l),
                  c = p.move(n, l) + "z")),
                  d.push(h),
                  g.push(c)) : (h += p.curve(n + v, l, r - v, o, r, o),
                  c += p.curve(n + v, l, r - v, o, r, o)),
                  n = r,
                  l = o,
                  s === e[i].length - 2 && (c = c + p.curve(n, l, r, o, r, b) + p.move(r, o) + "z",
                  ...
                  c += p.line(r, o)),
                  s === e[i].length - 2 && (c = c + p.line(r, b) + p.move(r, o) + "z",
                  d.push(h),
                  g.push(c))
              }
              return {
...
* Copyright (c) 2016 Wout Fierens; Licensed MIT */
  ...
  function() {
      ...
      function a(t) {
          ...
          case "A":
              t = (e = function(t, e) {
                  var i, a, s, r, o, n, l, h, c, d, g, u, f, p, x, b, v, m, y, w, k, A, S, C, L, P, M = Math.abs(e[1]), T = Math.abs(e[2]), I = e[3] % 360, z = e[4], X = e[5], E = e[6], Y = e[7], F = new SVG.Point(t), R = new SVG.Point(E,Y), H = [];
                  if (0 === M || 0 === T || F.x === R.x && F.y === R.y)
                      return [["C", F.x, F.y, R.x, R.y, R.x, R.y]];
                  i = new SVG.Point((F.x - R.x) / 2,(F.y - R.y) / 2).transform((new SVG.Matrix).rotate(I)),
                  (a = i.x * i.x / (M * M) + i.y * i.y / (T * T)) > 1 && (M *= a = Math.sqrt(a),
                  T *= a);
                  s = (new SVG.Matrix).rotate(I).scale(1 / M, 1 / T).rotate(-I),
                  F = F.transform(s),
                  R = R.transform(s),
                  r = [R.x - F.x, R.y - F.y],
                  n = r[0] * r[0] + r[1] * r[1],
                  ...
                  s = (new SVG.Matrix).rotate(I).scale(M, T).rotate(-I),
                  k = 0,
                  A = b.length; k < A; k++)
