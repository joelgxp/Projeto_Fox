...
!function(o) {
    ...
    function t() {
        ...
        setTimeout(function() {
            var e, n, a, o, i, r, t = document.querySelector("li.menuitem-active .active");
    ...
    return _createClass(e, [{
        ...
        value: function() {
            ...
            e && e.addEventListener("click", function() {
                ...
                "full" === t ? n.showBackdrop() : "condensed" === t ? n.changeLeftbarSize("condensed" == e ? "default" : e, !1) : n.changeLeftbarSize("condensed", !1),
        ...
        value: function() {
            var e = this;
            window.innerWidth <= 767.98 ? e.changeLeftbarSize("full", !1) : 767 <= window.innerWidth && window.innerWidth <= 1140 ? "full" !== e.config.sidenav.size && e.changeLeftbarSize("condensed", !1) : (e.changeLeftbarSize(e.config.sidenav.size),
        ...
        value: function() {
            ...
            var e, t, n, a, o, i, r, c = this.config;
            c && (e = document.querySelector("input[type=checkbox][name=data-bs-theme][value=" + c.theme + "]"),
            t = document.querySelector("input[type=checkbox][name=data-layout-mode][value=" + c.layout.mode + "]"),
            n = document.querySelector("input[type=checkbox][name=data-topbar-color][value=" + c.topbar.color + "]"),
            a = document.querySelector("input[type=checkbox][name=data-menu-color][value=" + c.menu.color + "]"),
            o = document.querySelector("input[type=checkbox][name=data-sidenav-size][value=" + c.sidenav.size + "]"),
...
let table = document.getElementById("table-responsive-sm")
        ...
        for (let i = 1; i < rows.length; i++) {
            ...
            for (j = 0; j < cells.length; j++) {
                if (cells[j]) {
                    ...
                    if (cellValue.includes(filter) && !cellValue.includes("<button>teste</button>")) {
